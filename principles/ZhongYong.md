...
3. 如果 $f(x_1) < f(x_2)$,
  這就意味着 $f$ 的最大值點 $m$ 在區間 $[x_1, r]$ 內，
  所以，我們把 $l$ 的值改爲 $x_1$；
  如果 $f(x_1) > f(x_2)$,
  這就意味着 $f$ 的最大值點 $m$ 在區間 $[l, x_2]$ 內，
  所以，此時我們把 $r$ 的值改爲 $x_2$；
  如果 $f(x_1) = f(x_2)$,
  這就意味着 $f$ 的最大值點 $m$ 在區間 $[x_1, x_2]$ 內，
...
等到上述過程從步驟 4 中跳出來結束的時候，我們找到的 $m$
的近似值與其精確值的差不會超過 $\delta$，這就是我們稱後者爲精度的原因。
