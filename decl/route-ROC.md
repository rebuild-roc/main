...
第一種想法就是中國的傳統帝制，也是毛澤東和習近平的想法，
第二種想法就是中共毛後習前的模式，兩種想法的危害不言自明。
其實就連第三種想法也危害很大：
* 第一，民主化的勝利果實很可能被抱有前兩種想法的人竊奪，
   最後的結果是沒有實現民主化；
* 第二，即便沒有出現上面的結局也會出現民主化之後存在着刻意製造的漏洞，
   因爲參與民主化進程的人既然知道自己有可能執政，
   那麼在設計未來的國家制度時就要選擇有利於自己的一些制度選項，
   在制度上出現刻意製造的漏洞或弊端，這些漏洞或弊端輕則造成日後的很多社會問題，
   重則使專制制度重新復辟；
* 第三，善於造反的人往往不善於治國，善於治國的人不一定願意造反，
   這就使得推翻中共的人和後中共時期最適合治國的人往往屬於不同的人羣。

此外，本文所描述的倒共建國方案需要很多專業人員：需要大量的程序員和網絡工程師，
需要經濟學家，需要法律專家，需要政治學專家，甚至需要數學家來研究或評估各種算法，
...
1. 參與倒共建國者應當摒棄個人英雄主義，匿名參與。
   ...
   [I2P](https://geti2p.net)）匿名行動，利用 PGP 密鑰證明自身身份，
   ...
   此爲借鑑，參與者斷不可以參與者的代號在自己的計算機或虛擬機中運行服務器
   （或分享文件）。

2. 將倒共建國這件事情產業化。

   國本來就是家的擴大化，或者說是古典農村與現代社區的擴大版。
...
3. 參與倒共建國的人在成功之後不執政，打算在未來的中華民國（大陸）
   ...
   大家知道，如果有幾個人來分一個西瓜（假設這些人誰都想多喫一點西瓜），
   能夠保證公平切分的辦法就是，讓一個人來操刀切瓜，切好之後讓其他人先挑瓜塊，
   把最後剩下的一塊瓜給操刀人。
   把這個原理用在建國大業上，那就是讓倒共建國的人不能執政。
   這一點不需要過多解釋。
