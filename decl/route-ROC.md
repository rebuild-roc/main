...
——幸虧習近平有巨大的人格缺陷和認知缺陷，若他雄才大略、知人善任，
則中共的極權主義體系將會絕塵而去，而民運人士只能被拋在歷史的滾滾煙塵後面，
除了在互聯網上作些錦繡文章、打些懸河口炮，對中共再也做不了什麼損害。
...
如果中共權貴階層做不到「還政於民、還富於民，和平下臺、遠離軍政法學媒」
這些要求，試圖負隅頑抗甚至犯下嚴重罪行，
...
在推翻中共的過程中，每一位參與者都應當儘量保護好自己不被中共當局追查到。
赤膊上陣、貿然犧牲是不足取的。我希望每一位參與者都能夠平安地從事倒共建國
這一工作，並且以自由之身笑著迎接中共倒臺的那一天。

第一，單純瀏覽筆者名下 <https://github.com/rebuild-roc/>
中各個倉庫中的文件是安全的。就是說，只要不登陸 GitHub 網站，僅僅以普通的瀏覽器
瀏覽上述網址是不會受到中共追查的。

第二，如果要傳播本文件或者文件中的各個網址，絕對不可使用微信，
也不可使用大陸的電子信箱，否則會受到中共當局的追查。
要傳播本文件或者其中的網址，應當以 [tor-browser](https://www.torproject.org)
(Tor 瀏覽器) 為瀏覽器在 <https://proton.me> 或 <https://tutanota.com>
等網站上註冊一個匿名的郵箱，並注意不要向這些網站提供電話號碼、其他郵箱等
各種個人信息。註冊成功後即可利用該郵箱向朋友們發送中共不喜歡的信息。
要注意，在發送出去的軟件正文中不要透露任何個人信息，也不要向郵件接受者暗示
您的真實身份。

第三，深度參與者僅靠 Tor 瀏覽器是不夠的。要深度參與，需要至少做到以下幾點：
1. 在自己的計算機中創建一個專用的虛擬機，用於參與倒共建國相關的各項工作。
   熟悉虛擬機使用方法的朋友可以根據自己的喜好選擇合適的虛擬機軟件，
   不熟悉的朋友可以選擇 [VirtualBox](https://www.virtualbox.org)
   這個軟件，利用該軟件創建一個專用的虛擬機，在這個虛擬機中不要留下任何個人信息。

   基於安全和可控的角度考慮，筆者建議虛擬機的操作系統為各種
   Linux 發行版中的一種。關於虛擬機的配置方法，筆者參照
   [編程隨想](https://program-think.blogspot.com)的文章之後，
   根據自己的使用心得設計了兩種方案，分別在
   <https://github.com/rebuild-roc/main/>
   的目錄中查找《如何建立和配置安全的工作環境 (I)》
   和《如何建立和配置安全的工作環境 (II)》即可得到文章的鏈接。
   以上兩個方案中的第二個比較簡單，如果不確定哪個方案好，可採用第二個。
2. 深度參與者應當在上述虛擬機中利用 gpg 產生自己的 openPGP 密鑰，
   一者用於往來郵件的加密，二者（也是主要的用途）用於必要情況下自證身份。
   深度參與者都是通過 Tor 網絡等暗網匿名活動的，相互之間用於識別的唯一憑證就是
   openPGP 密鑰。

   具體規則見 <https://github.com/rebuild-roc/main>
   中的《參與者的 openPGP 公鑰列表》。
3. 切記：除了系統維護之外，上面條款 1 中的虛擬機與互聯網的連接必須通過
   Tor 網絡等暗網，具體方法見條款 1 中所列文章。
   編程隨想雖然從 2021 年 5 月 9 日之後就不再活動了，
   但[他的博客](https://program-think.blogspot.com)仍然完整地保留了下來，
   各位同道者在深度參與之前最好研讀其中的相關文章。


[^PRC]: 這是筆者以「戡亂復國」為代號的用意。
[^XiJP]: 筆者在 2012 年之前就已經有本文所構思的主要框架，
  因此對習近平上臺前的言論立刻就領悟了其中的真實戰略構想。
[^repourl]: 本倉庫的網址為 <https://github.com/rebuild-roc/main/>。
[^share]: 為避免損害未出生人口的利益，應當從這些股份和福利中預留一部分，
  分配給未來十至三十年內出生的二代及二代以下公民（但不包括移民及其後裔）。
  未來所出生的公民所應得的股份和福利會隨著出生時間的推移而逐漸遞減，
  直至最後衰減為零。
